...
import contactImg from "../assets/Cisco.jpeg";
      ...
      >
        ...
        <div className="contactUsContainer">
            ...
            <div className="content1">
              <div className="content2">
                <div className="email">
                  ...
                  <Link>
                    <p>Mail us at : johndoe@gmail.com</p>
                  </Link>
                </div>
                ...
                <div className="location">
                  ...
                  <Link>
                    <p>We are loacted at:VJTI,Matunga ,Mumbai-400019</p>
                  </Link>
                </div>
              </div>
          ...
          <div className={`wrapper centered ${isSent ? "sent" : ""}`}>
            <form ref={form} className="contactForm" id="contactForm">
              <div className="letter">
                ...
                <div className="side">
                  ...
                  <p>
                    <button id="sendLetter" onClick={sendEmail}>
                      Send
                    </button>
                  </p>
                </div>
            ...
            <p className="result-message centered">
              {isSent ? "Thank you for your message!" : ""}
            </p>
          </div>
        </div>
      </div>
